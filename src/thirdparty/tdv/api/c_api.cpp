...
#include <thirdparty/tdv/modules/detection_modules/FaceDetectionModule.h>
#include <thirdparty/tdv/modules/MeshFitterModule.h>
#include <thirdparty/tdv/modules/FaceIdentificationModule.h>
#include <thirdparty/tdv/modules/MatcherModule.h>
#include <thirdparty/tdv/api/c_api.h>
#include <thirdparty/tdv/utils/rassert/RAssert.h>

#define CreatePB(x)                                                                                                    \
    if (!ctx.get<std::string>("model_path", "").compare(""))                                                           \
        new_ctx["model_path"] =                                                                                        \
            ctx["@sdk_path"].get<std::string>() + unitTypes.at(ctx["unit_type"].get<std::string>());                   \
    handle_ = new internal::x(new_ctx);                                                                                \
    return reinterpret_cast<HPBlock*>(handle_);

const std::map<std::string, std::string> unitTypes{
    {"FACE_DETECTOR", "face.onnx"},          // "/data/models/face_detector/face.onnx"
    {"FACE_RECOGNIZER", "recognizer.onnx"},  // "/data/models/recognizer/recognizer.onnx"
    {"MESH_FITTER", "mesh_fitter.onnx"},     // "/data/models/mesh_fitter/mesh_fitter.onnx"
    {"MATCHER_MODULE", ""},
};
...
struct ContextEH
{
    ...
    const void* userdata;
    ContextEH(internal::Error* ptr, void* data = nullptr) : ptr(ptr), userdata(data) {}
};
...
TDV_PUBLIC HContext* TDVContext_create(ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x56234801, e.what()), nullptr);
        return nullptr;
    }
}
...
TDV_PUBLIC void TDVContext_destroy(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x2dc17586, e.what()), nullptr);
    }
}
...
TDV_PUBLIC HContext* TDVContext_getByIndex(HContext* ctx, const int index, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x6ba98764, e.what()), nullptr);
        return nullptr;
    }
}
...
TDV_PUBLIC HContext* TDVContext_getOrInsertByKey(HContext* ctx, const char* key, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0xcb1ec66f, e.what()), nullptr);
        return nullptr;
    }
}
...
TDV_PUBLIC HContext* TDVContext_getByKey(HContext* ctx, const char* key, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0xb2a4ab43, e.what()), nullptr);
        return nullptr;
    }
}
...
TDV_PUBLIC HContext* TDVContext_clone(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0xf52416f4, e.what()), nullptr);
        return nullptr;
    }
}
...
TDV_PUBLIC void TDVContext_copy(HContext* src, HContext* dst, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x06e0b1ce, e.what()), nullptr);
    }
}
...
TDV_PUBLIC void TDVContext_putStr(HContext* ctx, const char* str, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0xaa600d43, e.what()), nullptr);
    }
}
...
TDV_PUBLIC void TDVContext_putLong(HContext* ctx, long val, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x88df0572, e.what()), nullptr);
    }
}
...
TDV_PUBLIC void TDVContext_putDouble(HContext* ctx, double val, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x75a049e2, e.what()), nullptr);
    }
}
...
TDV_PUBLIC void TDVContext_putBool(HContext* ctx, bool val, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0xccc7e754, e.what()), nullptr);
    }
}

TDV_PUBLIC void TDVContext_freePtr(void* ptr) { free(ptr); }
...
TDV_PUBLIC unsigned char* TDVContext_allocDataPtr(HContext* ctx, unsigned long size, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x4655ae44, e.what()), nullptr);
    }
    return data;
}

TDV_PUBLIC unsigned char* TDVContext_putDataPtr(HContext* ctx, unsigned char* val, unsigned long copy_sz,
                                                ContextEH** eh)
{
    unsigned char* data = nullptr;
    try
    {
        ...
        if (data)
        {
            if (copy_sz)
                ...
                *reinterpret_cast<internal::Context*>(ctx) =
                    std::shared_ptr<unsigned char>(data, [](unsigned char*) {});
        }
    }
    catch (std::exception& e)
    {
...
TDV_PUBLIC unsigned char* TDVContext_putConstDataPtr(HContext* ctx, const unsigned char* val, unsigned long copy_sz,
                                                     ContextEH** eh)
{
    unsigned char* data = nullptr;
    try
...
TDV_PUBLIC unsigned long TDVContext_getLength(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0xd45f61aa, e.what()), nullptr);
        return 0;
    }
}
...
TDV_PUBLIC char** TDVContext_getKeys(HContext* ctx, unsigned long length, ContextEH** eh)
{
    ...
    try
    {
        ...
        size_t index{0};
        for (auto keyValuePair = cMap->kvbegin(); (keyValuePair != cMap->kvend()) && (index < length);
             ++keyValuePair, ++index)
        {
...
TDV_PUBLIC bool TDVContext_isNone(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x96fac41a, e.what()), nullptr);
        return 0;
    }
}
...
TDV_PUBLIC bool TDVContext_isArray(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x96fac41b, e.what()), nullptr);
        return 0;
    }
}
...
TDV_PUBLIC bool TDVContext_isObject(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x96fac41c, e.what()), nullptr);
        return 0;
    }
}
...
TDV_PUBLIC bool TDVContext_isBool(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x96fac42c, e.what()), nullptr);
        return 0;
    }
}
...
TDV_PUBLIC bool TDVContext_isLong(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x96fac43c, e.what()), nullptr);
        return 0;
    }
}
...
TDV_PUBLIC bool TDVContext_isDouble(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x96fac44c, e.what()), nullptr);
        return 0;
    }
}
...
TDV_PUBLIC bool TDVContext_isString(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x96fac45c, e.what()), nullptr);
        return 0;
    }
}
...
TDV_PUBLIC bool TDVContext_isDataPtr(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x96fac46c, e.what()), nullptr);
        return 0;
    }
}
...
TDV_PUBLIC const char* TDVContext_getStr(HContext* ctx, char* buff, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x9097d24a, e.what()), nullptr);
    }
    return buff;
}
...
TDV_PUBLIC unsigned long TDVContext_getStrSize(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x8fc91369, e.what()), nullptr);
    }
    return size_s;
}
...
TDV_PUBLIC long TDVContext_getLong(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x2353ead7, e.what()), nullptr);
    }
    return data;
}
...
TDV_PUBLIC double TDVContext_getDouble(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0xd4fbd56c, e.what()), nullptr);
    }
    return data;
}
...
TDV_PUBLIC bool TDVContext_getBool(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0xfe8d07c6, e.what()), nullptr);
    }
    return data;
}
...
TDV_PUBLIC unsigned char* TDVContext_getDataPtr(HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x51228370, e.what()), nullptr);
    }
    return data;
}
...
TDV_PUBLIC void TDVContext_pushBack(HContext* handle_, HContext* data, bool copy, ContextEH** eh)
{
    try
    {
        if (copy)
            ...
            reinterpret_cast<internal::Context*>(handle_)->push_back(
                std::move(*reinterpret_cast<internal::Context*>(data)));
    }
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x6b8d124a, e.what()), nullptr);
    }
}
...
TDV_PUBLIC void TDVProcessingBlock_destroyBlock(HPBlock* handle_, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0xfa7b73ff, e.what()), nullptr);
    }
}
...
TDV_PUBLIC void TDVProcessingBlock_processContext(HPBlock* handle_, HContext* ctx, ContextEH** eh)
{
    ...
    catch (std::exception& e)
    {
        if (!eh)
            throw;
        *eh = new ContextEH(new internal::Error(0x9398017a, e.what()), nullptr);
    }
}
...
TDV_PUBLIC const char* TDVException_getMessage(ContextEH* eh)
{
    if (eh && eh->ptr)
        ...
        throw std::invalid_argument("nullptr error handler");
}

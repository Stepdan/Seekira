...
void STrack::activate(bytetrack::KalmanFilter& kalman_filter, int frame_id)
{
...
void STrack::multi_predict(std::vector<STrack*>& stracks, bytetrack::KalmanFilter& kalman_filter)
{
